...
from config_eeg import get_all_fnames, fname, bads, fmin, fmax, fnotch, tasks, runs
...
raw_fnames = get_all_fnames(args.subject, kind='raw', tasks=tasks, runs=runs)
filt_fnames = get_all_fnames(args.subject, kind='filt',tasks=tasks, runs=runs)
